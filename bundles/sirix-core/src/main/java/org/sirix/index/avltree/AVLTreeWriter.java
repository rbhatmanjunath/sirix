    ...
    try {
      ...
      switch (type) {
        case PATH:
          ...
          pathPage.createPathIndexTree(pageWriteTrx, index, pageWriteTrx.getTrxIntentLog());
          break;
        case CAS:
          ...
          casPage.createCASIndexTree(pageWriteTrx, index, pageWriteTrx.getTrxIntentLog());
          break;
        case NAME:
          ...
          namePage.createNameIndexTree(pageWriteTrx, index, pageWriteTrx.getTrxIntentLog());
          break;
        default:
          // Must not happen.
      }
